...
This will install [helm](https://helm.sh/) in your cluster so you can deploy charts.
...
This Vagrantfile is taken from [https://github.com/ecomm-integration-ballerina/kubernetes-cluster](https://github.com/ecomm-integration-ballerina/kubernetes-cluster) and slightly modified to copy ssh keys inside the cluster (install [https://github.com/dotless-de/vagrant-vbguest](https://github.com/dotless-de/vagrant-vbguest) is highly recommended)
